...
По ссылке URL: https://disk.yandex.ru/d/we\_pQkf5pbdiIA скачать архив «VectorField» и распаковать его.

Открыть распакованную папку «VectorField» и найти файл \texttt{VectorField.sln}. Нажать на найденный файл правой кнопкой мыши и выбрать «Открыть с помощью» -> «Microsoft Visual Studio 2019» («Microsoft Visual Studio 2022») (рис. 4.1).
...
\begin{thebibliography}{0}
	...
	https://www.swrit.ru (Дата обращения: 30.06.2025).
