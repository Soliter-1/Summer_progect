...
В данном программном документе приведена пояснительная записка к программе «VectorField», предназначенной для визуализации эквипотенциальных поверхностей и силовых линей двух полей, заданных двумя векторами и областью определения, а также расчета и отображения параметров этих вектор-полей.
...
Название программы: <<Программа расчета параметров векторных полей>>.
...
\begin{figure}[H]	
	\includegraphics[width=0.95\linewidth]{pics/100.png}
	\label{fig:1}
...
\begin{figure}[H]	
	\centering
	\includegraphics[width=0.8\linewidth]{pics/100.png}
	\label{fig:1}
	\caption{Главная кнопочная форма}
\end{figure} 
